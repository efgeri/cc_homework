...
public class ShipController {
    ...
    public ResponseEntity<List<Ship>> findShipsThatHavePiratesNamed(@RequestParam(name="named") String firstName){
        return new ResponseEntity<>(shipRepository.findShipByPiratesName(firstName), HttpStatus.OK);
    }
